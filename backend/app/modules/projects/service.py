...
def _project_to_detail(
    ...
    *,
    ...
    return ProjectDetail(
        ...
        taxonomie_verte_uemoa_aligned=project.taxonomie_verte_uemoa_aligned,
        gcf_priority_themes=list(project.gcf_priority_themes or []),
        gender_inclusion=project.gender_inclusion,
        vulnerable_populations=list(project.vulnerable_populations or []),
        project_esg_score=project.project_esg_score,
        auto_generated=project.auto_generated,
        created_at=project.created_at,
