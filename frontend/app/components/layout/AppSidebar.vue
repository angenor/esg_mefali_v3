  ...
  >
    ...
    <nav class="flex-1 py-4">
      ...
      >
        ...
        <!-- Icone dossiers de candidature -->
        <svg v-else-if="item.icon === 'applications'" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0" viewBox="0 0 20 20" fill="currentColor">
